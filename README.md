# Ecommerce-Database
MySQL-based E-Commerce database with schema, relationships, sample data, and ER diagram.
...
<img width="1226" height="794" alt="image" src="https://github.com/user-attachments/assets/c94f2a15-51ca-4e4c-8483-e37a2bcc3bc4" />


## 📌 Objective
This project focuses on designing and implementing a complete E-Commerce database using MySQL. It manages customers, products, categories, orders, order items, and payments with proper relationships.

## 🗂️ Database Tables

### 1. Customers
Stores customer personal details like name, email, phone, and address.

### 2. Categories
Contains product categories such as Electronics, Mobile Phones, etc.

### 3. Products
Stores product details including name, price, stock, brand, and category.

### 4. Orders
Contains order details placed by customers.
